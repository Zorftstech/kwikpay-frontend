...
import {Container, Heading, Text, Flex, Box, Icon, useColorModeValue, createIcon, Stack, Button, Input } from '@chakra-ui/react'
...
const Newsletter: React.FC<NewsletterProps> = () => {
    return (
        <Container maxW="lg" py='3rem' px='4rem'>
            <Flex justifyContent='center' alignItem='center' gap='2rem'>
                <Box w='50%'>
                    <Heading fontSize='54px' fontWeight='600' mb='1rem'>Get tips on how to run your business smarter</Heading>
                    <Text fontSize='24px' fontWeight='400' lineHeight='32px'>Learn crucial tips on how to save money and build a flourishing business, with real entrepreneurs sharing their own experiences.</Text>
                    <Stack spacing={4} direction={{ base: 'column', md: 'row' }} w={'full'}>
                    </Stack>
                </Box>
                <Flex justifyContent='center' alignItem='center' flexDir='column' w='50%'>
                    <Input
                        type={'email'}
                    ...
                    {/* <Icon as={NotificationIcon} w={54} h={54} /> */}
                </Flex>
            </Flex>
        </Container>
    )
