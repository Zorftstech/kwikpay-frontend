...
const Testimonial = (props: Props) => {
  ...
  return <Box mx='1rem'>{children}</Box>
}
...
const TestimonialAvatar = ({
  ...
  return (
    <Flex align={'center'} mt={'1.2rem'} direction={'column'}>
      <Avatar src={src} mb='1rem' borderRadius='50%' w='60px' h='60px' />
